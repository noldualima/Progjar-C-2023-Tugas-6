...
class Chat:
    def __init__(self):
        ...
        self.users = {'messi': {'nama': 'Lionel Messi', 'negara': 'Argentina', 'password': 'surabaya', 'incoming': {}, 'outgoing': {}},
                      'henderson': {'nama': 'Jordan Henderson', 'negara': 'Inggris', 'password': 'surabaya', 'incoming': {}, 'outgoing': {}},
                      'lineker': {'nama': 'Gary Lineker', 'negara': 'Inggris', 'password': 'surabaya', 'incoming': {}, 'outgoing': {}},
                      'ronaldo': {'nama': 'Christiano Ronaldo', 'negara': 'Portugal', 'password': 'surabaya', 'incoming': {}, 'outgoing': {}},
                      'maguire': {'nama': 'Harry Maguire', 'negara': 'Inggris', 'password': 'surabaya', 'incoming': {}, 'outgoing': {}}}
    ...
    def proses(self, data):
        ...
        try:
            ...
            if command == 'auth':
                ...
                for w in j[4:]:
                    message = "{} {}".format(message, w)
                logging.warning("SendServer: session {} sent message from {} to {}@{}".format(sessionid, server_id))
